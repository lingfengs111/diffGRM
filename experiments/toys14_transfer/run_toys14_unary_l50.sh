...
root="$repo/runs/toys14_transfer_l50/random_encoder4_unary_ar"
...
CUDA_VISIBLE_DEVICES="$gpu" TOKENIZERS_PARALLELISM=false "$python_bin" \
  ...
  --sid-config experiments/amazon14_domains/toys14_l50.yaml \
  ...
  --variant unary --conditioner diffusion_encoder \
