...
env CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES:-1}" TOKENIZERS_PARALLELISM=false \
    ...
    --variant pairwise --conditioner diffusion_encoder \
    --pair-rank 51 --allow-pair-rank-expansion \
    ...
    --output-dir "$run_root/video23_pairwise_rank51_continue2_v1"
